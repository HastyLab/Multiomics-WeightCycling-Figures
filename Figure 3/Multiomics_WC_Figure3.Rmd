...
This figure is intended to validate the study by comparing Lean to Obese mice and showing that changes in abundance for most of the cell populations matches the literature.

## Figure 3A

```{r Fig3Asetup, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Fig3A, echo=TRUE, warning=FALSE, message=FALSE, fig.width=6, fig.height=5}
...
```{r Fig3B, message=FALSE, warning=FALSE, fig.height=6, fig.width=6}
...
## Figure 3C
I provide multiple options for plotting this (order, color, etc).
```{r fig3Csetup, fig.width=6, fig.height=6, message=FALSE, warning=FALSE}
...
```{r permplot, warning=FALSE, message=FALSE}
...
```{r Fig3Cdata, warning=FALSE, message=FALSE}
...
```{r Fig3Coption1, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
...
```{r Fig3Coption2, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
...
```{r Fig3Coption3, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
...
```{r Fig3Coption4, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
ggplot(plot_data1, aes(x = clusters, y = obs_log2FD, facet=lowlevel)) +
		geom_pointrange(aes(ymin = boot_CI_2.5, ymax = boot_CI_97.5, color = significance)) +
		theme_bw() +
		geom_hline(yintercept = log2(1.5), lty = 2) +
...
```{r Fig3Dsetup, warning=FALSE, message=FALSE}
...
```{r Fig3Dstats, fig.width=4, fig.height=6, warning=FALSE, message=FALSE}
...
CompareDiets <- function(COI, #Cluster of interest
                         ...
                         showp, #True or False to show test and p value above graph
...
```{r Fig3D, warning=FALSE, message=FALSE, fig.width=2.5, fig.height=3}
# P value shown
...
# P value hidden (obscures points)
leanCOIs <- list("Tissue Resident Macrophages","Th2 CD4+ T Cells","Tregs","ILC2s")
for (coi in leanCOIs){
CompareDiets(COI=coi, 
             Group1="Lean",
...
```{r Fig3E, warning=FALSE, message=FALSE, fig.width=2.5, fig.height=3}
# P value shown
