...
bodymass <- read.csv("../Inputs/SuppFig1/HLC90_Seq-Mice_BodyMass.csv")
...
#Import Food Intake
foodintake <- read.csv("../Inputs/SuppFig1/HLC90_Seq-Mice_FoodIntake.csv")
...
#Import ipGTT
gtt <- read.csv("../Inputs/SuppFig1/HLC90_Seq-Mice_ipGTT.csv")
...
#Import Sac Mass
tissuemass <- read.csv("../Inputs/SuppFig1/HLC90_Seq-Mice_eATMass.csv")
...
```{r Supp1a, fig.height=3, fig.width=4}
...
```{r Supp1b, fig.height=3, fig.width=4}
...
## Supplemental Figure 1C and 1D

```{r Supp1candd, fig.height=3, fig.width=4}
#Total mass
...
```{r Supp1e, fig.height=3, fig.width=4}
...
```{r Supp1f, fig.height=3, fig.width=4}
