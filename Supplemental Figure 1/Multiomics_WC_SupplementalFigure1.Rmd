...
ggplot(subset(bodymass, Time_wk==3 & Week==3), aes(x=Group, y=Bodymass, fill=Group)) + 
  geom_bar(stat="summary",size=2, position="dodge") + 
  geom_errorbar(data=subset(bodymass_sem, Time_wk==3 & Week==3), aes(x=Group, ymin=Bodymass-sem, ymax=Bodymass+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() + 
...
ggplot(subset(bodymass, Time_wk==9 & Week==9), aes(x=Group, y=Bodymass, fill=Group)) + 
  geom_bar(stat="summary",size=2, position="dodge") + 
  geom_errorbar(data=subset(bodymass_sem, Time_wk==9 & Week==9), aes(x=Group, ymin=Bodymass-sem, ymax=Bodymass+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() + 
  labs(x="", y="Body Mass (g)") +
  ylim(0,60) + 
...
ggplot(subset(bodymass, Time_wk==18 & Week==18), aes(x=Group, y=Bodymass, fill=Group)) + 
  geom_bar(stat="summary",size=2, position="dodge") + 
  geom_errorbar(data=subset(bodymass_sem, Time_wk==18 & Week==18), aes(x=Group, ymin=Bodymass-sem, ymax=Bodymass+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() + 
  labs(x="", y="Body Mass (g)") +
  ylim(0,60) + 
...
ggplot(subset(bodycomp,Source=="Lean_mass" & Time_wk==18), aes(x=Group, y=Bodycomp, fill=Group)) + 
  geom_bar(stat="summary") + 
  geom_errorbar(data=subset(bodycomp_sem, Source=="Lean_mass" & Time_wk==18), aes(ymin=Bodycomp-sem, ymax=Bodycomp+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() +  
  ylim(0,30) +
  labs(x="", y="Lean Mass (g)") + 
...
ggplot(subset(bodycomp,Source=="Fat_mass" & Time_wk==3), aes(x=Group, y=Bodycomp, fill=Group)) + 
  geom_bar(stat="summary") + 
  geom_errorbar(data=subset(bodycomp_sem, Source=="Fat_mass" & Time_wk==3), aes(ymin=Bodycomp-sem, ymax=Bodycomp+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() +  
  ylim(0,25) +
  labs(x="", y="Fat Mass (g)") + 
...
ggplot(subset(bodycomp,Source=="Fat_mass" & Time_wk==9), aes(x=Group, y=Bodycomp, fill=Group)) + 
  geom_bar(stat="summary") + 
  geom_errorbar(data=subset(bodycomp_sem, Source=="Fat_mass" & Time_wk==9), aes(ymin=Bodycomp-sem, ymax=Bodycomp+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() +   
  ylim(0,25) +
  labs(x="", y="Fat Mass (g)") + 
