...
ggplot(subset(f_bodycomp,Source=="Lean_mass"), aes(x=Group, y=Bodycomp, fill=Group)) + 
  ...
  geom_errorbar(data=subset(f_bodycomp_sem, Source=="Lean_mass"), aes(ymin=Bodycomp-sem, ymax=Bodycomp+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() +  
  ylim(0,30) +
...
ggplot(subset(f_bodycomp,Source=="Fat_mass"), aes(x=Group, y=Bodycomp, fill=Group)) + 
  geom_bar(stat="summary", width=0.8) + 
  geom_errorbar(data=subset(f_bodycomp_sem, Source=="Fat_mass"), aes(ymin=Bodycomp-sem, ymax=Bodycomp+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() +  
  ylim(0,25) +
  labs(x="", y="Fat Mass (g)") + 
...
ggplot(f_auc_sem, aes(x=Group, y=AUC, fill=Group)) + 
  ...
  geom_errorbar(data=f_auc_sem, aes(ymin=AUC-sem, ymax=AUC+sem), width=0.25) + 
  theme_pubr(base_size=12) +
  NoLegend() + 
