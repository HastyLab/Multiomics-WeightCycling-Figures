...
```{r SuppFig5A, echo=TRUE, fig.width=12, fig.height=4, warning=FALSE, message=FALSE}
fig6cols <- c(rep("#e6e6e6",20),"#99000D","#876149","#6e3f22",rep("#e6e6e6",10))
...
```{r SuppFig5Bsetup, warning=FALSE, message=FALSE}
SuppFig5gdNKTcells <- subset(data.integrated, highlevel2=="gd T Cells" | highlevel2=="NK Cells" | highlevel2=="NKT Cells" )
```

```{r SuppFig5B, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
Idents(SuppFig5gdNKTcells) <- SuppFig5gdNKTcells$highlevel2
DefaultAssay(SuppFig5gdNKTcells) <- "RNA"
VlnPlot(SuppFig5gdNKTcells, 
...
```{r SuppFig5Csetup, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r SuppFig5Cstats, echo=TRUE, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
...
```{r SuppFig5C, echo=TRUE, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
