...
subtitle: "Supplemental Figure 7"
output:
  html_document:
    toc: yes
    df_print: paged
...
```{r SuppFig7A, echo=TRUE, fig.width=12, fig.height=4, warning=FALSE, message=FALSE}
...
```{r SuppFig7Bsetup, warning=FALSE, message=FALSE}
SuppFig7gdNKTcells <- subset(data.integrated, highlevel2=="gd T Cells" | highlevel2=="NK Cells" | highlevel2=="NKT Cells" )
```

```{r SuppFig7B, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
...
```{r SuppFig7Csetup, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r SuppFig7Cstats, echo=TRUE, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
...
```{r SuppFig7C, echo=TRUE, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
