...
```{r SuppFig7Asetup, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
...
```{r SuppFig7A, fig.width=2, fig.height=2, warning=FALSE, message=FALSE}
...
```{r SuppFig7B, fig.width=2, fig.height=2, warning=FALSE, message=FALSE}
...
DimPlot(ref, reduction="umap", label=F, cols=c(rep("#e8e8e8",9))) + 
  new_scale("color") + 
        geom_point(LeanPTils_ex, 
                   ...
                   size = 1.5, 
                   shape = 16) +
  scale_color_viridis(option="A", limits=c(-1,1.5),breaks=c(-1,0,1)) +
  theme_void() +
  NoLegend() 
