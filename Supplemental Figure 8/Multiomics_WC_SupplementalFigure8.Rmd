...
```{r SuppFig8A, echo=TRUE, fig.width=12, fig.height=4, warning=FALSE, message=FALSE}
...
```{r SuppFig8csetup, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r SuppFig8cstats, echo=TRUE, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
...
```{r SuppFig8c, echo=TRUE, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
...
```{r SuppFig8d, fig.width=12, fig.height=3, warning=FALSE, message=FALSE}
