...
subtitle: "Supplemental Figure 8"
output:
  html_document:
    toc: yes
    df_print: paged
...
```{r SuppFig8A, fig.width=12, fig.height=4, warning=FALSE, message=FALSE}
...
```{r SuppFig8Bsetup, warning=FALSE, message=FALSE}
SuppFig8Bcells <- subset(data.integrated, highlevel2=="Naive B Cells" | 
                           highlevel2=="Memory B Cells"|
                           highlevel2=="B-1a Cells"|
                           highlevel2=="Plasma Cells")
```

```{r SuppFig8B, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
Idents(SuppFig8Bcells) <- SuppFig8Bcells$highlevel2
DefaultAssay(SuppFig8Bcells) <- "RNA"
VlnPlot(SuppFig8Bcells, 
...
```{r SuppFig8Csetup, warning=FALSE, message=FALSE, fig.width=6, fig.height=6}
...
```{r SuppFig8cstats, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
...
```{r SuppFig8c, fig.width=3, fig.height=3, warning=FALSE, message=FALSE}
...
```{r SuppFig8Dsetup, warning=FALSE, message=FALSE}
...
```{r SuppFig8d, fig.width=5, fig.height=5, warning=FALSE, message=FALSE}
